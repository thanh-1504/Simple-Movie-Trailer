...
const MovieCardItem = ({ item }) => {
  ...
  return (
    <div className="cursor-pointer movie-card ">
      <img
        className="rounded-xl w-[200px] h-[150px] hover:scale-[1.07] ease-linear duration-200 w-full h-full object-cover"
        src={`https://image.tmdb.org/t/p/original${poster_path}`}
        alt=""
      />
      <p className="my-3 text-sm font-bold text-white">{title}</p>
