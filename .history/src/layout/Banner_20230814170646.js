  ...
  return (
    <div className="relative">
      ...
      <div className="absolute w-full banner-info left-16 top-[7.25rem] ">
        ...
        <p className="mb-3 text-sm text-white text-gray-400">{dateRelease}</p>
        <div className="flex items-center justify-between w-[1024px]">
          <div className="">
            <p className="mb-3 text-base font-bold text-white ">Story Line</p>
            <p className="text-sm text-gray-400 max-w-[300px]  text-white">
              {overview}
            </p>
            <div className="cast">
        ...
        <div className="flex items-center w-full mt-6">
          ...
          <div>
            <Button
              className={
                " hover:bg-gray-400 hover:text-black relative left-[570px] outline-1"
              }
            >
              Like
            </Button>
