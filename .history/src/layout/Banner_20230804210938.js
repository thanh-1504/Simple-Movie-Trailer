  ...
  return (
    <div className="relative">
      ...
      <div className="absolute w-full banner-info bottom-32 left-16 ">
        ...
        <p className="mb-6 text-sm text-gray-400">{dateRelease}</p>
        <div className="flex items-center justify-between w-[1280px]">
          ...
          <div>
            <Button className={" hover:bg-gray-400 hover:text-black"}>
              Like
            </Button>
          </div>
        </div>
      ...
      <div className="mt-8">
        ...
        <p className="text-sm text-gray-400">
          ...
          explicabo aliquam vero aspernatur quidem earum quibusdam doloremque
          illum autem facilis sed fugiat delectus sint veniam repellendus,
          deserunt eveniet vitae!
        </p>
        <div className="cast">
