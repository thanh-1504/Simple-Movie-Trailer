...
const Header = () => {
  ...
  const headerRef = useRef(
    <div className="header flex font-bold items-center justify-center translate-y-[-2%] text-white sticky z-9999 w-full  h-[50px] bg-black ">
  ...
  return <React.Fragment>{headerRef.current}</React.Fragment>;
};
