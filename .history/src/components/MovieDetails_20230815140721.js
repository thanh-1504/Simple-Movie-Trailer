...
const MovieInfo = ({ dataItem }) => {
  ...
  return (
    <div className="movie_detail flex max-w-[1280px]">
      <div className="flex movie_info bg-[#222222] px-3 py-3 mt-5 max-w-[766px] ">
        ...
        <div className="ml-4 text-white">
          ...
          <p className="mb-1 text-sm text-textColor max-w-[290px]">
            Diễn viên:{" "}
            <span className="ml-2 text-white ">
              {cast.slice(0, 5).map((item, index) => {
                if (index === 4) return <span>{`${item.name}`}</span>;
...
const MovieDetails = () => {
  ...
  const itemData = data;
  return (
    <div className="relative z-50 top-[55px] h-auto pl-[120px] ">
