      ...
      <div className="movie_detail">
        <div className="flex  movie_info max-w-[1280px] px-[100px] py-6">
          ...
          <div className="ml-4 text-white">
            ...
            <p className="mb-1 text-textColor">Năm sản xuất: 2023</p>
            <p className="mb-1 text-textColor">Thể loại: Hành động</p>
            <p className="mb-1 text-textColor">Diễn viên: Nsdadasda</p>
          </div>
        </div>
      </div>
    </div>
