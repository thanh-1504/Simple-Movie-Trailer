      ...
      <div className="relative form_wrapper">
        ...
        <div className="form_body  bg-white absolute  z-10  top-[50%] translate-y-[-50%] left-[50%] translate-x-[-50%]">
          <div className="form_content">
            <div className="p-4 form_content-wrapper ">
              <h1 className="text-[32px] font-medium text-[#fff] mb-5">
                Đăng Nhập
              </h1>
              <form action="" className="flex flex-col">
                <Input
                  className=" mb-4 max-w-[316px] py-[13px]"
                  type="text"
                  placeholder="Email hoặc số điện thoại"
                ></Input>
                <Input
                  className=" mb-5  max-w-[316px] py-[13px]"
                  type="password"
                  placeholder="Mật Khẩu"
                ></Input>

                <Button className="bg-[#e50914] rounded font-medium w-[316px] h-[50px] mb-2 ">
                  Đăng Nhập
                </Button>
                <p>
