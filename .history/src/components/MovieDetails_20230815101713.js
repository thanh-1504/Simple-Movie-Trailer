...
const MovieDetails = () => {
  return (
    <div className="relative z-50 top-[55px] h-auto pl-[160px] ">
      ...
      <div className="bg-[#282828] max-w-[630px]">
        <p className="text-white mt-8 uppercase text=gray-500 text-sm mb-2">
          Nội dung phim
        </p>
        <p className="text-white max-w-[600px] text-xs text-gray-800">
