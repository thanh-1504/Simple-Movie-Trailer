  ...
  return (
    <div className="relative z-50 top-[55px] bg-[#222222] h-auto ">
      <div className="movie_detail">
        <div className="flex items-center movie_info max-w-[1280px] px-[100px] py-6">
          <div>
            <img
              ...
              alt=""
              className="relative w-[300px] h-[400px] object-cover"
            />
            <div className="absolute bottom-0 h-8 bg-cyan-300">
