  ...
  return (
    <div className="relative z-50 top-[55px]  h-auto ">
      <div className="movie_detail flex max-w-[1280px]">
        ...
        <div className="mt-8 ml-[180px]">
          <h2 className="text-[#cf966a] text-3xl">Phim sắp chiếu</h2>
          <p className="text-gray-500">-------------------------------</p>
          <div>
            <div>
              <img
                src="https://images.unsplash.com/photo-1478720568477-152d9b164e26?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8bW92aWV8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=600&q=60"
                alt=""
                className="w-[75px] h-[90px] object-cover w-full h-full"
              />
              <div>
                <h3>Quân Tâm Khó Đoán</h3>
                <p>2023</p>
                <svg
